                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                %>
                                            <td><%=parkingSpot.mLongitude%></td>
                                            <td><%=parkingSpot.mLatitude%></td>
                                            <td><%=parkingSpot.mIsOccupied%></td>
                                            <td><%=parkingSpot.mOccupiedStartTime%></td>
                                            <td><%=parkingSpot.mOccupiedEndTime%></td>
                                <%
                                        }
                                    }
                                %>
